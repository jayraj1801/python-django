               ...
               <div class="newsletter-area">
                  <div class="newsletter-top">
                     <div class="row gy-4 align-items-center">
                        ...
                        <div class="col-lg-7">
                         <form class="newsletter-form">  <!--<input class="form-control" type="email" placeholder="Enter Email" required=""> !--><button type="submit" class="th-btn style3">Contact us <img src="assets/img/icon/plane.svg" alt=""></button></form>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <script src="assets/js/vendor/jquery-3.6.0.min.js"></script><script src="assets/js/swiper-bundle.min.js"></script>
      <script src="assets/js/imagesloaded.pkgd.min.js"></script><script src="assets/js/isotope.pkgd.min.js"></script>
      <script src="assets/js/gsap.min.js"></script><script src="assets/js/circle-progress.js"></script>
      <script src="assets/js/matter.min.js"></script><script src="assets/js/matterjs-custom.js"></script>
      <script src="assets/js/nice-select.min.js"></script><script src="assets/js/main.js"></script>
   </body>
</html>